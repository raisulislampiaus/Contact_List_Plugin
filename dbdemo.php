...
add_action( 'admin_menu', function () {
    add_menu_page( 'Contact List Plugin', 'Contact List Plugin', 'manage_options', 'dbdemo', 'dbdemo_admin_page' );
} );
    ...
    <div class="form_box">
        ...
        <div class="form_box_content">
            <form action="<?php echo admin_url( 'admin-post.php' ); ?>" method="POST">
                ...
                <select id="hobbies" name="hobbies[]" class="form_text" multiple="multiple" style="width: 100%;">
                    <option value="Reading"<?php if ($id && in_array('Reading', $hobbies)) echo ' selected="selected"'; ?>>Reading</option>
                    <option value="Swimming"<?php if ($id && in_array('Swimming', $hobbies)) echo ' selected="selected"'; ?>>Swimming</option>
                    <option value="Running"<?php if ($id && in_array('Running', $hobbies)) echo ' selected="selected"'; ?>>Running</option>
                    <option value="Biking"<?php if ($id && in_array('Biking', $hobbies)) echo ' selected="selected"'; ?>>Biking</option>
...
add_action( 'admin_enqueue_scripts', function() {
    ...
    // Inline JS for Select2
    $custom_js = "
    jQuery(document).ready(function($) {
        $('#hobbies').select2({
            tags: true,
            tokenSeparators: [',', ' '],
            placeholder: 'Select or add your hobbies',
            allowClear: true,
